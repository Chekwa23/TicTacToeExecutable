...
public class Main extends Application
{
    ...
    /**
     * Constructor initializing variables and throwing a FileNotFoundException
...
//        srcx = new FileInputStream(String.valueOf(getClass().getResourceAsStream("x.jpg")));
//        srco = new FileInputStream(String.valueOf(getClass().getResourceAsStream("o.jpg")));
        oh = new Image(getClass().getResourceAsStream("x.jpg"));
        ex = new Image(getClass().getResourceAsStream("o.jpg"));
//        root = new Pane();
...
//        primaryStage.show();
        ...
        primary.setScene(new Scene(root, 600, 670));
        primary.show();
    }
